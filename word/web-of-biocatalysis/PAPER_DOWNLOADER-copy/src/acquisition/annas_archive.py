    ...
    if title:
        ...
        if results:
            ...
            for result in results[:10]:  # Try more results for title search
                ...
                if similarity > 0.5:  # Reasonable match
                    print(f"    Trying: {result_title[:60]}... (similarity: {similarity:.2f})")
                    ...
                    print(f"    Skipping: {result_title[:60]}... (similarity: {similarity:.2f} too low)")
